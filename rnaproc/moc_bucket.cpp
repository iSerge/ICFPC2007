...
static const char qt_meta_stringdata_Bucket[] = {
    "Bucket\0"
};

const QMetaObject Bucket::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Bucket,
      qt_meta_data_Bucket, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Bucket))
        return static_cast<void*>(const_cast< Bucket*>(this));
